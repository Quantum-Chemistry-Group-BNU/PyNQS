...
template <typename T>
void get_comb_SD(unsigned long *comb, T *lst, const int *merged,
...
template void get_comb_SD<float>(unsigned long *comb, float *lst,
                                 const int *merged, const int r0,
                                 const int sorb, const int len, const int noA,
                                 const int noB);

template void get_comb_SD<double>(unsigned long *comb, double *lst,
                                  const int *merged, const int r0,
                                  const int sorb, const int len, const int noA,
                                  const int noB);
