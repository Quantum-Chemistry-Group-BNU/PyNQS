...
template <typename T>
__device__ void get_comb_SD_cuda(unsigned long *comb, T *lst,
...
template __device__ void get_comb_SD_cuda<float>(unsigned long *comb,
                                                 float *lst,
                                                 const int *merged,
                                                 const int r0,
                                                 const int sorb,
...
template __device__ void get_comb_SD_cuda<double>(unsigned long *comb,
                                                  double *lst,
                                                  const int *merged,
                                                  const int r0,
                                                  const int sorb,
