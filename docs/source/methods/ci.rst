...
.. math::
   |n_0n_1n_2n_3n_4n_5\rangle := (\hat{a}^\dagger_0)^{n_0} (\hat{a}^\dagger_1)^{n_1} (\hat{a}^\dagger_2)^{n_2} (\hat{a}^\dagger_3)^{n_3} (\hat{a}^\dagger_4)^{n_4} (\hat{a}^\dagger_5)^{n_5} |\rm vac\rangle
